...
const AddTodoForm = ({ buttonInfo, placeholder, onTodoAdd, onTodoUpdate, todoValue }) => {
    ...
    <div>
      ...
      >
        <div className="grouped">
          <Input className="" value={inputValue} placeholder={placeholder} onChange={handleChange} />
